...
export const creativeMapPoints = [
  {
    id: "map-pacific-coast",
    label: "Pacific Coast photo folder",
    coordinates: [-122.851, 38.083],
    kind: "photography",
  ...
  {
    id: "map-high-desert",
    label: "High Desert photo folder",
    coordinates: [-116.319, 33.873],
    kind: "photography",
